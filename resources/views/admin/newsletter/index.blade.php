                            ...
                            @foreach($cities as $c)
                                <tr id="main_cat_{{$c->id}}" onclick="myFunction({{$c->id}})">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('deleteNewsletter',$c->id)}}" >
                                    ...
                                    <div class="modal fade" id="edit_{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="{{route('editNewsletter')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row {{ $errors->has('title_ar') ? ' has-error' : '' }}">
                                                            <label class="col-lg-12 control-label {{Session::get("lang") =="ar" ? 'text-lg-right' : 'text-lg-left'}}" for="textinput">Email</label>
                                                            <div class="col-lg-12">
                                                                <input name="email" type="text" placeholder="{{trans('admin.email')}}" class="form-control btn-square" value="{{$c->email}}" required>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="subCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{route('newsletters.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input id="name" name="email" type="text" placeholder="{{trans('admin.email')}}" class="form-control btn-square" required>
                            </div>
                        </div>
