...
@section('content')
    @if(admin()->hasPermissionTo('Show dashboard'))
        <div class="page-body" dir="{{Session::get("lang") =="ar" ? 'rtl' : 'ltr'}}">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <div class="{{Session::get("lang") =="ar" ? 'page-header-right' : 'page-header-left'}}">
                                <h3>{{--{{ trans('admin.dashboard.default')}}--}}{{trans('admin.default')}}</h3>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard"><i data-feather="home"></i></a></li>
                                    <li class="breadcrumb-item">{{trans('admin.dashboard')}}</li>
                                    <li class="breadcrumb-item active">{{trans('admin.default')}}</li>
                                </ol>
                            </div>
                        </div>
                </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="bg-primary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body"><span class="m-0">{{trans('admin.users')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['users']}}</h4><i class="icon-bg" data-feather="users"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-xl-3 col-lg-6">
                                <div class="card o-hidden">
                                    <div class="bg-primary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            <div class="align-self-center text-center"><i data-feather="users"></i></div>
                                            <div class="media-body"><span class="m-0">{{trans('admin.workers')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['workers']}}</h4><i class="icon-bg" data-feather="users"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="bg-primary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body"><span class="m-0">{{trans('admin.companyWorkers')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['workers_company']}}</h4><i class="icon-bg" data-feather="truck"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="bg-secondary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body"><span class="m-0">{{trans('admin.orders')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['orders_count']}}</h4><i class="icon-bg" data-feather="box"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="bg-secondary b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body"><span class="m-0">{{trans('admin.orders')}} {{trans('admin.monthly')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['monthly_orders_count']}}</h4><i class="icon-bg" data-feather="clock"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card o-hidden">
                                    <div class="bg-dark b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            ...
                                            <div class="media-body"><span class="m-0">{{trans('admin.orders')}} {{trans('admin.total')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['orders_total']}}</h4><i class="icon-bg" data-feather="dollar-sign"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-xl-3 col-lg-6">
                                <div class="card o-hidden">
                                    <div class="bg-dark b-r-4 card-body">
                                        <div class="media static-top-widget">
                                            <div class="align-self-center text-center"><i data-feather="dollar-sign"></i></div>
                                            <div class="media-body"><span class="m-0">{{trans('admin.orders')}} {{trans('admin.total')}} {{trans('admin.monthly')}}</span>
                                                <h4 class="mb-0 counter">{{$dashboard['orders_total_monthly']}}</h4><i class="icon-bg" data-feather="dollar-sign"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="mobile-clock-widget">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <p class="m-0 f-14 text-light">{{trans('admin.cairo')}}, {{trans('admin.egypt')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-12 col-sm-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin.ordersLast30')}}<span class="digits"></span>
                        </h4>
                    </div>
                    @if($orders_charts)
                        <div class="card-body chart-block">
                            <div class="chart-overflow" id="orders"></div>
                        </div>
                    @else
                        <h6 style="text-align: center">{{trans('admin.noOrders')}}</h6>
                    @endif
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 col-xl-6">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin.usersLast30')}}<span class="digits"></span>
                        </h4>
                    </div>
                    @if($users_charts)
                        <div class="card-body chart-block">
                    ...
                    @else
                        <h6 style="text-align: center">{{trans('admin.noUsers')}}</h6>
                    @endif
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin.workersLast30')}}<span class="digits"></span>
                        </h4>
                    </div>
                    @if($users_charts)
                        <div class="card-body chart-block">
                            <div class="chart-overflow" id="workers"></div>
                        </div>
                    @else
                        <h6 style="text-align: center">{{trans('admin.noWorkers')}}</h6>
                    @endif
            </div>
        </div>
