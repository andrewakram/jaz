...
<div class="page-wrapper">
    <div class="auth-bg">
        <div class="authentication-box">
            <div class="text-center"><img src="{{asset('admin/assets/images/logo.png')}}" height="50px" width="50px" alt=""></div>
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <form action="{{route('login')}}" method="post" class="theme-form">
                        ...
                        <div class="mg-t-60 tx-center">
                            <a target="_blank" href="http://2grand.net/">
                                <img src="{{asset('public/public/android.png')}}" style="max-width: 20% !important;display: table;margin: 0 auto;">
                            </a>
                        </div>
