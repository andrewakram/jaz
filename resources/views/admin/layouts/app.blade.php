                                    ...
                                    <ul class="sidebar-menu" dir="{{Session::get("lang") =="ar" ? 'rtl' : 'ltr'}}">
                                        ...
                                        <li>
                                            <a class="sidebar-header" href="{{route('costsReport')}}">
                                                ...
                                                <span>
                                                        {{trans('admin.CsotsReport')}}
                                                        <b>({{trans('admin.worker')}})</b>
                                                    </span>
                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                            </a>
                                        ...
                                        @if(admin()->hasPermissionTo('View orders'))
                                            <li>
                                                <a class="sidebar-header" href="{{route('costsUserReport')}}">
                                                    <i data-feather="file"></i>
                                                    {{--<i class="fa fa-file-excel-o"></i>--}}
                                                    <span>
                                                        {{trans('admin.CsotsReport')}}
                                        ...
                                        @endif
                                                ...
                                                <li>
                                                <a class="sidebar-header" href="{{route('sliders.index')}}">
                                                    <i data-feather="command"></i>
                                                    <span>Slider </span>
                                                    <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                </a>
                                        ...
                                        @if(admin()->hasPermissionTo('Show dashboard'))
                                                <li><a class="sidebar-header" href="#"><i data-feather="command"></i><span>Website</span><i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i></a>
                                                    <ul class="sidebar-submenu">
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('sliders.index')}}">
                                                                <i data-feather="command"></i>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('parteners.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Parteners </span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('visions.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Vision</span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('benfits.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Benfits</span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('newsletters.index')}}">
                                                                <i data-feather="command"></i>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('contactus.index')}}">
                                                                <i data-feather="command"></i>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('teams.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Team </span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('services.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Services </span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('clientreviews.index')}}">
                                                                <i data-feather="command"></i>
                                                        ...
                                                        <li>
                                                            <a class="sidebar-header" href="{{route('albums.index')}}">
                                                                <i data-feather="command"></i>
                                                                <span>Albums </span>
                                                                <i class="fa {{Session::get("lang") =="ar" ? 'fa-angle-left pull-left' : 'fa-angle-right pull-right'}}"></i>
                                                            </a>
