                        ...
                        <table class="table">
                            ...
                            @foreach($cities as $c)
                                <tr id="main_cat_{{$c->id}}" onclick="myFunction({{$c->id}})">
                                    ...
                                    <td>{{$c->comment_en}} / {{$c->comment_ar}}</td>
                                    <td>
                                        ...
                                        <a href="{{route('deleteReview',$c->id)}}" >
                                    ...
                                    <div class="modal fade" id="edit_{{$c->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="{{route('editReview')}}" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <textarea name="comment_en" class="form-control" rows="4" placeholder="{{trans('admin.englishText')}}" >{{$c->comment_en}}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <textarea name="comment_ar" class="form-control" rows="4" placeholder="{{trans('admin.arabicText')}}" >{{$c->comment_ar}}</textarea>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="subCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{route('clientreviews.store')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <label>{{trans('admin.name')}}</label>
                                <input  name="name" type="text" placeholder="{{trans('admin.name')}}" class="form-control btn-square" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <label>{{trans('admin.englishText')}}</label>
                                <textarea name="comment_en" class="form-control" rows="4" placeholder="{{trans('admin.englishText')}}" ></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <label>{{trans('admin.arabicText')}}</label>
                                <textarea name="comment_ar" class="form-control" rows="4" placeholder="{{trans('admin.arabicText')}}" ></textarea>
                            </div>
                        </div>
