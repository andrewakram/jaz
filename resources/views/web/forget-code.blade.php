                    ...
                    {{--<form class="cons-contact-form wow zoomIn" method="post" >--}}
                        ...
                        <div class="wrapper fadeInDown">
                            ...
                            <div id="formContent">
                                ...
                                <!-- Login Form -->
                                <form  role="form" method="post" enctype="multipart/form-data" action="{{url('/confirm-resetPass')}}">
                                    @csrf
                                    ...
                                    <input type="hidden" id="" class="fadeIn second" name="type" value="{{$type}}">
                                    <input type="text" id="login" class="fadeIn second" name="code" placeholder="{{__('web.code')}}" required>

                                    <button type="submit" value="submit" class="ref">{{__('web.confirm')}}</button>
                                    {{--<a href="{{route('webNew-password')}}" class="ref" > Confirm</a>--}}
                                </form>
