                ...
                <div class="container">
                                    ...
                                    <span class="link-inner">
                                        ...
                                        <span class="woo-cart-count">
                                            <span class="shopping-bag wcmenucart-count ">
                                                {{ sizeof(Session::get("active_orders_in_cart")) > 0 ?  sizeof(Session::get("active_orders_in_cart")) : "?" }}
                                            </span>
                                        </span>
                                    </span>
                            </a>
                    ...
                    <div class="header-nav navbar-collapse collapse ">
                        <ul class=" nav navbar-nav">
                            <li class="{{Session::get('active') == 'home' ? 'active' :'' }}">
                                <a href="{{asset('/')}}">{{__('web.home')}}</a>

                            </li>

                            <li class="{{Session::get('active') == 'about' ? 'active' :'' }}">
                                <a href="{{asset('/about-us')}}">{{__('web.aboutJaz')}}</a>


                            </li>

                            <li class="{{Session::get('active') == 'orders' ? 'active' :'' }}">
                                <a href="{{asset('/active-requests')}}">{{__('web.myOrders')}}</a>

                            </li>

                            <li class="{{Session::get('active') == 'companies' ? 'active' :'' }}">
                                <a href="{{asset('/acceptedcompanies')}}">{{__('web.companies')}}</a>

                            </li>

                            <li class="submenu-direction {{Session::get('active') == 'terms' ? 'active' :'' }}">
                                <a href="{{asset('/terms-condition')}}">{{__('web.terms')}}</a>

                            </li>

                            <li class="has-mega-menu {{Session::get('active') == 'contact' ? 'active' :'' }}">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget_services">
                        ...
                        <ul>
                            ...
                            <li><a href="{{url('/')}}#jazGallery">{{__('web.gallery')}}</a></li>
                        </ul>
                    </div>
                </div>
                <!-- USEFUL LINKS -->
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget_newsletter">
                        <h4 class="widget-title">{{trans('web.newsletter')}}<!--Newsletter--></h4>
