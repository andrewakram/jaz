...
class OrderController extends Controller
{
    ...
    public function __construct(OrdersRepositoryInterface $ordersRepository, AuthRepositoryInterface $authRepository,\App\Http\Controllers\Interfaces\Worker\AuthRepositoryInterface $workerAuthRepository)
    {
    ...
    public function create(Request $request)
    {
        $validator = Validator::make($request->all(),[
            ...
            'third_cat_id' => 'sometimes|exists:categories,id',
            ...
            'image' => 'sometimes',
            'video' => 'sometimes',
            'order_choice' => 'required|numeric|in:1,2',
            'city_id' => 'required|exists:cities,id'

            /*'order_choice' => '1 = users , 2 = companies',*/
        ]);
        ...
        {
            $city_check=DB::table('city_categories')
            ...
            if($city_check){
                ...
                return response()->json(msg($request, failed(), 'no_available_in_city'));
            }
